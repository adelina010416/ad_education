...
from users.views import UserProfileView, EditProfileView, RegisterView, \
    verify_view, confirm_mail, UserPasswordResetDoneView, \
    UserPasswordResetView, wrong_mail, UserPasswordChangeView, \
    password_changed, login_fail
...
urlpatterns = [
    ...
    path('reset_done/', UserPasswordResetDoneView.as_view(),
         name='reset_done'),
    path('recover-password/', UserPasswordResetView.as_view(),
